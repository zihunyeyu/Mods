...
function RefreshGovernors()
	...
	m_GovernorsInstance.AlertIndicator:SetShow((bCanAppoint or bCanPromote) and bttPointsLeft);
	m_GovernorsInstance.AlertIndicator:SetToolTipString(((bCanAppoint or bCanPromote) and bttPointsLeft) and Locale.Lookup("LOC_GOVERNOR_ACTION_AVAILABLE") or nil );

	--print('My loaded xxxxxxxxxx', bttPointsLeft, bCanAppoint or bCanPromote and bttPointsLeft)
end
