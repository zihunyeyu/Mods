-- UnitFlagManager_TKH_NO_BMode
-- Author: PurpleSoul
-- DateCreated: 3/5/2025 8:05:49 PM
--------------------------------------------------------------
print('Load file UnitFlagManager_TKH_NO_BMode.lua')
...
--	REDRIVE
-- ===========================================================================
local TKH_UpdateHealth           = UnitFlag.UpdateHealth
local TKH_UpdateName             = UnitFlag.UpdateName
local TKH_OnUnitSelectionChanged = OnUnitSelectionChanged
local TKH_Subscribe              = Subscribe
local TKH_Unsubscribe            = Unsubscribe
